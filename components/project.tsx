...
export default function Project({
    ...
    return (
     ...
     border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] group-even:pl-8 hover:bg-gray-200 transition rounded-lg'>
        ...
        flex flex-col h-full group-even:ml-[18rem]'>
             ...
             shadow-2xl transition group-even:right-[initial] group-even:-left-40
